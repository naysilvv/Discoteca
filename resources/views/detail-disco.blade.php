	...
	<body>
		...
		<div class="container-login100">
		     <form class="logincadastrodisco validate-form">
					        ...
					        <div class="disco9">
								<input type="text" id="image22" class="oi" size="30" value="Nayara" disabled>
								<input type="text" id="image22" class="oi" size="30" value="Cazuza" disabled>
							    <input type="text" id="image22" class="oi" size="30" value="1950" disabled>
								<input type="text" id="image22" class="oi" size="30" value="50,00" disabled>
							</div>

							<div class="disco9">
							     <div class="ImageContainer2">
								 <img src="disco.png" id="image22" alt="imagem do disco">
								 </div>
							</div>
